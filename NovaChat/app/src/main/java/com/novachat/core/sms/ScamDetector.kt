...
class ScamDetector @Inject constructor(
    ...
    private val rules: List<PatternRule> = listOf(
        ...
        PatternRule(Regex("בבחירות.*בוחרים|בוחרים.*בבחירות"), ScamCategory.POLITICAL_SPAM, 0.76f, "Hebrew: in elections voting for"),
        PatternRule(Regex("בחירות.*הצביעו|הצביעו.*בחירות"), ScamCategory.POLITICAL_SPAM, 0.74f, "Hebrew: elections vote"),
        PatternRule(Regex("יום הבחירות.*בוחרים|בוחרים.*יום הבחירות"), ScamCategory.POLITICAL_SPAM, 0.76f, "Hebrew: election day voting for"),
